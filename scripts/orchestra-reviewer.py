...
CLONES_ROOT = ROOT / "workspaces/.orchestra-reviewer-clones"
WORKER_MODULE_PATH = REPO / "scripts/orchestra-worker.py"
...
REVIEW_BEGIN = "ORCHESTRA_REVIEW_JSON_BEGIN"
REVIEW_END = "ORCHESTRA_REVIEW_JSON_END"
...
RUNTIME_USER = WORKER.RUNTIME_USER
...
def build_prompt(
    *,
    ...
    return f"""
You are the independent read-only Orchestra reviewer.
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Orchestra independent read-only reviewer"
    )
